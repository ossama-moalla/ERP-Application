...
namespace ERP_System.Models.Maintenance.Reports
{
    public class Report_MaintenanceOPRs_Year_ReportDetail
    {
        ...
        internal static List<Report_MaintenanceOPRs_Year_ReportDetail> Get_Report_MaintenanceOPRs_Year_ReportDetail_List_From_DataTable(System.Data.DataTable table)
        {
            try
            {
