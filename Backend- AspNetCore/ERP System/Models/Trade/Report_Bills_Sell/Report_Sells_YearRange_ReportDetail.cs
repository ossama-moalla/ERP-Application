...
namespace ERP_System.Models.Trade.Report_Bills_Sell
{
    public class Report_Sells_YearRange_ReportDetail
    {
        ...
        internal static List<Report_Sells_YearRange_ReportDetail> Get_Report_Sells_YearRange_ReportDetail_From_DataTable(System.Data.DataTable table)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < table.Rows.Count; i++)
                {
                    ...
                    list.Add(new Report_Sells_YearRange_ReportDetail(YearNO, Bills_Count, Bills_Clause_Count, Bills_Value, Bills_Pays_Value, Bills_Pays_Remain,
